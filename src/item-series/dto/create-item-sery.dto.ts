...
export const createItemSerySchema = z.object({
  ...
  imageUrl: z.string('image must be a valid URL').optional(),
...
// Remove the unused strict function, as .strict() is a Zod method and does not require a separate implementation.
